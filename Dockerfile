...
RUN curl -O http://jenkins-registrar.dev-prsn.com:8080/view/PaaS%20POC/job/openshift-deploy-singleService/lastSuccessfulBuild/artifact/service/target/org-association-jar-with-dependencies.jar
...
ENV SERVERS "java -classpath org-association-jar-with-dependencies.jar com.pearson.grid.orgassociation.Main"
